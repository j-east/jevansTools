...
Options:
  -p, --port <port>       Proxy port to listen on (default: ${types_1.DEFAULT_CONFIG.port})
  -u, --ui <port>         Web UI port (default: 8081, use 0 to disable)
  --no-open               Don't auto-open browser
  -l, --log <file>        Log file path (default: ${types_1.DEFAULT_CONFIG.logFile})
  -w, --watch <domains>   Comma-separated list of domains to watch
                          (default: ${types_1.DEFAULT_CONFIG.watchDomains.join(',')})
  -v, --verbose           Enable verbose logging (headers, response bodies)
  -c, --cert-dir <dir>    Directory for CA certificates (default: ${types_1.DEFAULT_CONFIG.certDir})
...
async function main() {
    ...
    const proxy = new proxy_1.ProxyServer(config, uiPort && uiPort > 0 ? uiPort : undefined);
